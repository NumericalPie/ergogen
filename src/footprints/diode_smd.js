// SMD-only diode (SOD-123), pads on both faces for reversible boards.
// Same interface as the stock `diode` footprint, minus the THT legs.
module.exports = {
    params: {
        designator: 'D',
        from: undefined,
    ...
    (module DiodeSMD (layer F.Cu) (tedit 5B24D78E)
